...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.Form=void 0;var e=require("./DOM");class a{static fill(a,t){for(const s in t){const c=(0,e.$_)("form[data-form='".concat(a,"'] [name='").concat(s,"']")).get(0);if(void 0!==c)switch(c.type){case"file":case"file[]":break;default:c.value=t[s]}}}static values(a){const t={};return(0,e.$_)("form[data-form='".concat(a,"'] [name]")).each(e=>{let a;switch(e.type){case"file[]":a=e.files;break;case"file":a=e.files[0];break;default:a=e.value}null!=a&&(t[e.name]=a)}),t}}exports.Form=a;
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.LocalStorage=void 0;class t{constructor({name:t="",version:e="",store:s=""}){this.name=t,this.version=e,this.store=s,this.upgrades={},""===this.version?this.numericVersion=0:this.numericVersion=parseInt(e.replace(/\./g,"")),this.id=""!==t&&""!==e&&""!==s?"".concat(this.name,"::").concat(this.store,"::").concat(this.version,"_"):""!==t&&""!==e?"".concat(this.name,"::").concat(this.version,"_"):""!==t?"".concat(this.name,"::_"):""}open(){return"object"!=typeof this.storage||this.storage instanceof Promise?this.storage instanceof Promise?this.storage:(this.storage=new Promise(t=>{let e=[];if(""!==this.version){let t="";""!==this.name&&""!==this.version&&""!==this.store?t="".concat(this.name,"::").concat(this.store,"::"):""!==this.name&&""!==this.version&&(t="".concat(this.name,"::"));const s=Object.keys(window.localStorage).filter(e=>0===e.indexOf(t)).map(e=>e.replace(t,"").split("_")[0]).filter(t=>-1===t.indexOf("::")).sort();if(s.length>0){const t=s[0],i=parseInt(t.replace(/\./g,""));if(i<this.numericVersion){const s=Object.keys(this.upgrades).sort(),o=s.findIndex(t=>{const[e]=t.split("::");return parseInt(e)===i});o>-1&&(e=s.slice(o).filter(t=>{const[e,s]=t.split("::");return parseInt(e)<this.numericVersion&&parseInt(s)<=this.numericVersion}));let r="".concat(this.name,"::").concat(t,"_");""!==this.name&&""!==this.version&&""!==this.store?r="".concat(this.name,"::").concat(this.store,"::").concat(t,"_"):""!==this.name&&""!==this.version&&(r="".concat(this.name,"::").concat(t,"_"));const n=Object.keys(window.localStorage).filter(t=>0===t.indexOf(r)).map(t=>t.replace(r,""));for(const t of n){const e=window.localStorage.getItem("".concat(r).concat(t));window.localStorage.setItem(this.id+t,e),window.localStorage.removeItem("".concat(r).concat(t))}}}}t({upgrades:e})}).then(({upgrades:t})=>(this.storage=window.localStorage,new Promise(e=>{this._upgrade(t,()=>e(this))}))),this.storage):Promise.resolve(this)}set(t,e){return this.open().then(()=>("object"==typeof e?this.storage.setItem(this.id+t,JSON.stringify(e)):this.storage.setItem(this.id+t,e),Promise.resolve({key:t,value:e})))}update(t,e){return this.get(t).then(s=>("object"==typeof s?("object"==typeof e&&(e=Object.assign({},s,e)),this.storage.setItem(this.id+t,JSON.stringify(e))):this.storage.setItem(this.id+t,e),Promise.resolve({key:t,value:e}))).catch(()=>this.set(t,e))}get(t){return this.open().then(()=>new Promise((e,s)=>{let i=null;i=this.storage.getItem(this.id+t);try{const t=JSON.parse(i);t&&"object"==typeof t&&(i=t)}catch(o){}null!=i?e(i):s()}))}getAll(){return this.keys().then(t=>{const e={},s=[];for(const i of t)s.push(this.get(i).then(t=>{e[i]=t}));return Promise.all(s).then(()=>e)})}contains(t){return this.keys().then(e=>{if(!e.includes(t))return Promise.reject();Promise.resolve()})}upgrade(t,e,s){return this.upgrades["".concat(parseInt(t.replace(/\./g,"")),"::").concat(parseInt(e.replace(/\./g,"")))]=s,Promise.resolve()}_upgrade(t,e){t.length>0?this.upgrades[t[0]].call(this,this).then(()=>{this._upgrade(t.slice(1),e)}).catch(t=>console.error(t)):e()}rename(t){return this.name!==t?this.keys().then(e=>{const s=this.id;this.name=t,""!==this.name&&""!==this.version&&""!==this.store?this.id="".concat(this.name,"::").concat(this.store,"::").concat(this.version,"_"):""!==this.name&&""!==this.version?this.id="".concat(this.name,"::").concat(this.version,"_"):""!==this.name?this.id="".concat(this.name,"::_"):this.id="";const i=[];for(const t of e)i.push(this.set(t,this.storage.getItem("".concat(s).concat(t))).then(()=>{this.storage.removeItem("".concat(s).concat(t))}));return Promise.all(i)}):Promise.reject()}key(t,e=!1){return this.open().then(()=>!0===e?Promise.resolve(this.storage.key(t)):Promise.resolve(this.storage.key(t).replace(this.id,"")))}keys(t=!1){return this.open().then(()=>Promise.resolve(Object.keys(this.storage).filter(t=>0===t.indexOf(this.id)).map(e=>!0===t?e:e.replace(this.id,""))))}remove(t){return this.get(t).then(e=>(this.storage.removeItem(this.id+t),Promise.resolve(e)))}clear(){return this.keys().then(t=>{for(const e of t)this.remove(e);return Promise.resolve()})}}exports.LocalStorage=t;
