...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,n){for(var o=0;o<n.length;o++){var t=n[o];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(e,t.key,t)}}return function(n,o,t){return o&&e(n.prototype,o),t&&e(n,t),n}}();function n(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}var o=exports.Request=function(){function o(){n(this,o)}return e(o,null,[{key:"get",value:function(e,n){var o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"";return new Promise(function(t,r){var i=[];for(var u in n)i.push(encodeURIComponent(u)+"="+encodeURIComponent(n[u]));var a=new XMLHttpRequest;i.length>0&&(e=e+"?"+i.join("&")),a.open("GET",e,!0),a.responseType=o,a.onload=function(){t(a.response)},a.onerror=function(){r(a)},a.send()})}},{key:"post",value:function(e,n){var o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"",t=arguments.length>3&&void 0!==arguments[3]?arguments[3]:"application/x-www-form-urlencoded";return new Promise(function(r,i){var u=void 0,a=new XMLHttpRequest;if(a.open("POST",e,!0),"application/x-www-form-urlencoded"==t){for(var s in u=[],n)u.push(encodeURIComponent(s)+"="+encodeURIComponent(n[s]));u=u.join("&"),a.setRequestHeader("Content-type",t)}else if("multipart/form-data"==t)for(var p in u=new FormData,n)u.append(p,n[p]);a.responseType=o,a.onload=function(){r(a.response)},a.onerror=function(){i(a)},a.send(u)})}},{key:"json",value:function(e){return new Promise(function(n,o){var t=new XMLHttpRequest;t.responseType="json",t.onload=function(){n(t.response)},t.onerror=function(){o(t)},t.open("GET",e,!0),t.send()})}}]),o}();
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("./src/DOM");Object.keys(e).forEach(function(r){"default"!==r&&"__esModule"!==r&&Object.defineProperty(exports,r,{enumerable:!0,get:function(){return e[r]}})});var r=require("./src/Form");Object.keys(r).forEach(function(e){"default"!==e&&"__esModule"!==e&&Object.defineProperty(exports,e,{enumerable:!0,get:function(){return r[e]}})});var t=require("./src/Platform");Object.keys(t).forEach(function(e){"default"!==e&&"__esModule"!==e&&Object.defineProperty(exports,e,{enumerable:!0,get:function(){return t[e]}})});var u=require("./src/Request");Object.keys(u).forEach(function(e){"default"!==e&&"__esModule"!==e&&Object.defineProperty(exports,e,{enumerable:!0,get:function(){return u[e]}})});var n=require("./src/Space");Object.keys(n).forEach(function(e){"default"!==e&&"__esModule"!==e&&Object.defineProperty(exports,e,{enumerable:!0,get:function(){return n[e]}})});var o=require("./src/Text");Object.keys(o).forEach(function(e){"default"!==e&&"__esModule"!==e&&Object.defineProperty(exports,e,{enumerable:!0,get:function(){return o[e]}})});
},{"./src/DOM":3,"./src/Form":4,"./src/Platform":5,"./src/Request":6,"./src/Space":7,"./src/Text":8}]},{},[1], "Artemis")
