...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},t=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}();function n(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var r=exports.Space=function(){function r(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"",t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"",o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:r.Type.Local;n(this,r),this.name=e,this.type=o,this.version=t,this.callbacks={},""!==e&&""!==t?(this.numericVersion=parseInt(t.replace(/\./g,"")),this.id=this.name+"::"+this.version+"_"):""!==t?(this.numericVersion=parseInt(t.replace(/\./g,"")),this.id=this.name+"::"+this.version+"_"):o!=r.Type.Local&&o!=r.Type.Session||(this.numericVersion=0,this.id="")}return t(r,[{key:"open",value:function(){var e=this,t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;return void 0!==this.storage?Promise.resolve(this):this.type===r.Type.Local?(this.storage=window.localStorage,Promise.resolve(this)):this.type===r.Type.Session?(this.storage=window.sessionSpace,Promise.resolve(this)):this.type===r.Type.IndexedDB?new Promise(function(n,r){e.storage=window.indexedDB.open(e.name,e.numericVersion),e.storage.onerror=function(e){r(e)},e.storage.onsuccess=function(t){e.storage=t.target.result,n(e)},e.storage.onupgradeneeded=function(r){e.storage=r.target.result,t(e.storage).then(function(){n(e)})}}):void 0}},{key:"set",value:function(t,n){var o=this;return this.open().then(function(){return o.type!==r.Type.Local&&o.type!==r.Type.Session||("object"===(void 0===n?"undefined":e(n))?o.storage.setItem(o.id+t,JSON.stringify(n)):o.storage.setItem(o.id+t,n)),void 0!==o.callbacks.onStore&&o.callbacks.onStore.call(null,t,n),Promise.resolve(n)})}},{key:"get",value:function(t){var n=this;return this.open().then(function(){return new Promise(function(o){var i=void 0;switch(n.type){case r.Type.Local:case r.Type.Session:i=n.storage.getItem(n.id+t);try{var s=JSON.parse(i);s&&"object"===(void 0===s?"undefined":e(s))&&(i=s)}catch(e){}break;case r.Type.IndexedDB:}o(i)})})}},{key:"upgrade",value:function(t,n,o){var i=this;return this.open().then(function(){if(i.type===r.Type.Local||i.type===r.Type.Session){var n=Object.keys(i.storage).filter(function(e){return 0===e.indexOf(i.name+"::"+t+"_")}).map(function(e){return e.replace(i.name+"::"+t+"_","")}),s=[],a=function(n){var r=i.storage.getItem(i.name+"::"+t+"_"+n);try{var a=JSON.parse(r);a&&"object"===(void 0===a?"undefined":e(a))&&(r=a)}catch(e){}s.push(o.call(null,n,r).then(function(e){i.set(n,e).then(function(){i.storage.removeItem(i.name+"::"+t+"_"+n)})}))},c=!0,u=!1,l=void 0;try{for(var y,p=n[Symbol.iterator]();!(c=(y=p.next()).done);c=!0){a(y.value)}}catch(e){u=!0,l=e}finally{try{!c&&p.return&&p.return()}finally{if(u)throw l}}return Promise.all(s)}return Promise.reject()})}},{key:"rename",value:function(e){var t=this;return this.open().then(function(){return t.name!==e&&(t.type===r.Type.Local||t.type===r.Type.Session)?t.keys().then(function(n){var r=t.id;t.name=e,t.id=t.name+"::"+t.version+"_";var o=[],i=function(e){o.push(t.set(e,t.storage.getItem(""+r+e)).then(function(){t.storage.removeItem(""+r+e)}))},s=!0,a=!1,c=void 0;try{for(var u,l=n[Symbol.iterator]();!(s=(u=l.next()).done);s=!0){i(u.value)}}catch(e){a=!0,c=e}finally{try{!s&&l.return&&l.return()}finally{if(a)throw c}}return Promise.all(o)}):Promise.reject()})}},{key:"onStore",value:function(e){this.callbacks.onStore=e}},{key:"onDelete",value:function(e){this.callbacks.onDelete=e}},{key:"key",value:function(e){var t=this,n=arguments.length>1&&void 0!==arguments[1]&&arguments[1];return this.open().then(function(){return t.type===r.Type.Local||t.type===r.Type.Session?!0===n?Promise.resolve(t.storage.key(e)):Promise.resolve(t.storage.key(e).replace(t.id,"")):Promise.reject()})}},{key:"keys",value:function(){var e=this,t=arguments.length>0&&void 0!==arguments[0]&&arguments[0];return this.open().then(function(){return e.type===r.Type.Local||e.type===r.Type.Session?Promise.resolve(Object.keys(e.storage).filter(function(t){return 0===t.indexOf(e.id)}).map(function(n){return!0===t?n:n.replace(e.id,"")})):Promise.reject()})}},{key:"remove",value:function(e){var t=this;return this.open().then(function(){if(t.type===r.Type.Local||t.type===r.Type.Session)return t.get(e).then(function(n){return t.storage.removeItem(t.id+e),void 0!==t.callbacks.onDelete&&t.callbacks.onDelete.call(null,e,n),Promise.resolve(e,n)});Promise.reject()})}},{key:"clear",value:function(){var e=this;return this.open().then(function(){if(e.type===r.Type.Local||e.type===r.Type.Session)return e.keys().then(function(t){var n=!0,r=!1,o=void 0;try{for(var i,s=t[Symbol.iterator]();!(n=(i=s.next()).done);n=!0){var a=i.value;e.remove(a)}}catch(e){r=!0,o=e}finally{try{!n&&s.return&&s.return()}finally{if(r)throw o}}return Promise.resolve()});Promise.reject()})}}]),r}();r.Type={Local:1,Session:2,Indexed:3};
},{}],7:[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,n){for(var r=0;r<n.length;r++){var t=n[r];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(e,t.key,t)}}return function(n,r,t){return r&&e(n.prototype,r),t&&e(n,t),n}}();function n(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}var r=exports.Text=function(){function r(){n(this,r)}return e(r,null,[{key:"capitalize",value:function(e){return e.replace(/\w\S*/g,function(e){return e.charAt(0).toUpperCase()+e.substr(1).toLowerCase()})}},{key:"suffix",value:function(e,n){var r="",t=n.indexOf(e);return-1!==t&&(t+=e.length,r=n.substr(t,n.length-t)),r}},{key:"prefix",value:function(e,n){var r="",t=n.indexOf(e);return-1!=t&&(r=n.substr(0,t)),r}},{key:"friendly",value:function(e){var n={"[áàâãªä]":"a","[ÁÀÂÃÄ]":"A","[ÍÌÎÏ]":"I","[íìîï]":"i","[éèêë]":"e","[ÉÈÊË]":"E","[óòôõºö]":"o","[ÓÒÔÕÖ]":"O","[úùûü]":"u","[ÚÙÛÜ]":"U","ç":"c","Ç":"C","ñ":"n","Ñ":"N",_:"-","[’‘‹›<>']":"",'[“”«»„"]':"","[(){}[]]":"","[?¿!¡#$%&^*´`~/°|]":"","[,.:;]":""," ":"-"};for(var r in n)e=e.replace(new RegExp(r,"g"),n[r]);return e}}]),r}();
...
},{"./src/DOM":3,"./src/Form":4,"./src/Platform":5,"./src/Request":8,"./src/Space":6,"./src/Text":7}]},{},[1], "Artemis")
