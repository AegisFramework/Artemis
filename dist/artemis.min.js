...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.$_=e,exports.$_ready=o,exports.DOM=void 0;class t{constructor(e){if(null===e)return this.collection=[],void(this.length=0);if("string"==typeof e)this.collection=document.querySelectorAll(e),this.length=this.collection.length,this._selector=e;else if(e instanceof NodeList)this.collection=e,this.length=e.length,this._selector=e;else if(e instanceof t)this.collection=e.collection,this.length=this.collection.length,this._selector=e._selector;else if(e instanceof HTMLElement)this.collection=[e],this.length=this.collection.length,this._selector=e;else{if("object"!=typeof e)return;e.length>=1?this.collection=e:this.collection=[e],this.length=this.collection.length,this._selector=e}}hide(){for(const t of this.collection)t.style.display="none"}show(t="block"){for(const e of this.collection)e.style.display=t}addClass(t){for(const e of this.collection)e.classList.add(t)}removeClass(t=null){if(null!==t)for(const e of this.collection)e.classList.remove(t);else for(const e of this.collection)for(;e.classList.length>0;)e.classList.remove(e.classList.item(0))}toggleClass(t){t=t.split(" ");for(const e of this.collection)for(let o=0;o<t.length;o++)e.classList.toggle(t[o])}hasClass(t){for(const e of this.collection)if(!e.classList.contains(t))return!1;return!0}value(t){if(void 0!==t)for(const e of this.collection)e.value=t;else if(this.length>0)return this.collection[0].value}focus(){this.length>0&&this.collection[0].focus()}click(t){for(const e of this.collection)e.addEventListener("click",t,!1)}keyup(t){for(const e of this.collection)e.addEventListener("keyup",t,!1)}keydown(t){for(const e of this.collection)e.addEventListener("keydown",t,!1)}submit(t){for(const e of this.collection)e.addEventListener("submit",t,!1)}change(t){for(const e of this.collection)e.addEventListener("change",t,!1)}scroll(t){for(const e of this.collection)e.addEventListener("scroll",t,!1)}on(t,o,i){t=t.split(" ");for(const l of this.collection)for(let n=0;n<t.length;n++)"function"==typeof o?l.addEventListener(t[n],o,!1):"string"==typeof o&&"function"==typeof i&&l.addEventListener(t[n],t=>{if(!t.target)return;const l=e(t.target).closestParent(o,this._selector);void 0!==l&&i.call(l.get(0),t)},!1)}filter(e){if(this.length>0)return new t(this.collection[0].querySelector(e))}data(t,e){if(void 0!==e)for(const o of this.collection)o.dataset[t]=e;else if(this.length>0)return this.collection[0].dataset[t]}removeData(t){for(const e of this.collection)delete e.dataset[t]}text(t){if(void 0!==t)for(const e of this.collection)e.textContent=t;else if(this.length>0)return this.collection[0].textContent}html(t){if(void 0!==t)for(const e of this.collection)e.innerHTML=t;else if(this.length>0)return this.collection[0].innerHTML}append(t){if(this.length>0)if("string"==typeof t){const e=document.createElement("div");e.innerHTML="string"==typeof t?t.trim():t,this.collection[0].appendChild(e.firstChild)}else this.collection[0].appendChild(t)}prepend(t){if(this.length>0)if("string"==typeof t){const e=document.createElement("div");e.innerHTML="string"==typeof t?t.trim():t,this.collection[0].childNodes.length>0?this.collection[0].insertBefore(e.firstChild,this.collection[0].childNodes[0]):this.collection[0].appendChild(e.firstChild)}else this.collection[0].childNodes.length>0?this.collection[0].insertBefore(t,this.collection[0].childNodes[0]):this.collection[0].appendChild(t)}each(t){for(const e of this.collection)t(e)}get(t){return this.collection[t]}first(){if(this.length>0)return new t(this.collection[0])}last(){if(this.length>0)return new t(this.collection[this.collection.length-1])}isVisible(){for(const t of this.collection)if("none"!=t.display&&t.offsetWidth>0&&t.offsetHeight>0)return!0;return!1}parent(){if(this.length>0)return new t(this.collection[0].parentElement)}find(e){if(this.length>0)return new t(this.collection[0].querySelectorAll(e))}offset(){if(this.length>0){const t=this.collection[0].getBoundingClientRect();return{top:t.top+document.body.scrollTop,left:t.left+document.body.scrollLeft}}}closest(t){let e=null,o=this;for(;void 0!==o&&null===e;){if(!0===o.matches(t))return o;const i=o.find(t);i&&i.length>0&&(e=i),o=o.parent()}return null!==e?e:o}closestParent(t,e){let o=this;for(;void 0!==o;){if(!0===o.matches(t))return o;if("string"==typeof e&&o.matches(e))break;o=o.parent()}}attribute(t,e){if(void 0!==e)for(const o of this.collection)o.setAttribute(t,e);else if(this.length>0)return this.collection[0].getAttribute(t)}hasAttribute(t){for(const e of this.collection)if(!e.hasAttribute(t))return!1;return!0}after(t){for(const e of this.collection)e.insertAdjacentHTML("afterend",t)}before(t){for(const e of this.collection)e.insertAdjacentHTML("beforebegin",t)}style(t,e){for(let o=0;o<this.collection.length;o++)if("string"==typeof t&&"undefined"!==e)this.collection[o].style[t]=e;else{if("string"==typeof t&&"undefined"===e)return this.collection[o].style[t];if("object"==typeof t)for(const e in t)this.collection[o].style[e]=t[e]}}animate(t,e){for(let o=0;o<this.collection.length;o++)for(const i in t){const l=(new Date).getTime(),n=this.collection;let s,c;void 0!==this.collection[o].style[i]?(c=this.collection[o].style[i],s=setInterval(()=>{const r=Math.min(1,((new Date).getTime()-l)/e);n[o].style[i]=c+r*(t[i]-c),1==r&&clearInterval(s)},25),this.collection[o].style[i]=c):void 0!==this.collection[o][i]&&(c=this.collection[o][i],s=setInterval(()=>{const r=Math.min(1,((new Date).getTime()-l)/e);n[o][i]=c+r*(t[i]-c),1==r&&clearInterval(s)},25),this.collection[o][i]=c)}}fadeIn(t=400,e){if(this.length>0){const o=this.collection[0];o.style.opacity=0;let i=+new Date;const l=()=>{o.style.opacity=+o.style.opacity+(new Date-i)/t,i=+new Date,+o.style.opacity<1?window.requestAnimationFrame&&requestAnimationFrame(l)||setTimeout(l,16):"function"==typeof e&&e()};l()}}fadeOut(t=400,e){if(this.length>0){let o=+new Date;const i=this.collection[0],l=()=>{i.style.opacity=+i.style.opacity-(new Date-o)/t,o=+new Date,+i.style.opacity>0?window.requestAnimationFrame&&requestAnimationFrame(l)||setTimeout(l,16):"function"==typeof e&&e()};l()}}matches(t){const e=Element.prototype,o=e.matches||e.webkitMatchesSelector||e.mozMatchesSelector||e.msMatchesSelector||function(){return-1!==[].indexOf.call(document.querySelectorAll(t),this)};return this.length>0&&o.call(this.collection[0],t)}remove(){for(const t of this.collection)t.parentNode.removeChild(t)}replaceWith(t){let e=t;if("string"==typeof t){const o=document.createElement("div");o.innerHTML=t,e=o.firstChild}for(const o of this.collection)o.parentElement.replaceChild(e,o)}reset(){for(const t of this.collection)t.reset()}property(t,e){if(void 0!==e)for(const o of this.collection)o[t]=e;else if(this.length>0)return this.collection[0][t]}}function e(e){return void 0!==e?new t(e):t}function o(t){window.addEventListener("load",t)}exports.DOM=t;
