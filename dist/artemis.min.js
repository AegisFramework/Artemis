...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},t=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}();function r(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var n=exports.LocalStorage=function(){function n(e){var t=e.name,o=void 0===t?"":t,i=e.version,u=void 0===i?"":i,s=e.store,a=void 0===s?"":s;r(this,n),this.name=o,this.version=u,this.store=a,""===this.version?this.numericVersion=0:this.numericVersion=parseInt(u.replace(/\./g,"")),this.id=""!==o&&""!==u&&""!==a?this.name+"::"+this.store+"::"+this.version+"_":""!==o&&""!==u?this.name+"::"+this.version+"_":""!==o?this.name+"::_":""}return t(n,[{key:"open",value:function(){return void 0===this.storage&&(this.storage=window.localStorage),Promise.resolve(this)}},{key:"set",value:function(t,r){var n=this;return this.open().then(function(){return"object"===(void 0===r?"undefined":e(r))?n.storage.setItem(n.id+t,JSON.stringify(r)):n.storage.setItem(n.id+t,r),Promise.resolve({key:t,value:r})})}},{key:"update",value:function(t,r){var n=this;return this.get(t).then(function(o){return"object"===(void 0===o?"undefined":e(o))?("object"===(void 0===r?"undefined":e(r))&&(r=Object.assign({},o,r)),n.storage.setItem(n.id+t,JSON.stringify(r))):n.storage.setItem(n.id+t,r),Promise.resolve({key:t,value:r})})}},{key:"get",value:function(t){var r=this;return this.open().then(function(){return new Promise(function(n,o){var i=null;i=r.storage.getItem(r.id+t);try{var u=JSON.parse(i);u&&"object"===(void 0===u?"undefined":e(u))&&(i=u)}catch(e){}null!=i?n(i):o()})})}},{key:"getAll",value:function(){var e=this;return this.keys().then(function(t){var r={},n=[],o=function(t){n.push(e.get(t).then(function(e){r[t]=e}))},i=!0,u=!1,s=void 0;try{for(var a,c=t[Symbol.iterator]();!(i=(a=c.next()).done);i=!0){o(a.value)}}catch(e){u=!0,s=e}finally{try{!i&&c.return&&c.return()}finally{if(u)throw s}}return Promise.all(n).then(function(){return r})})}},{key:"contains",value:function(e){return this.keys().then(function(t){if(!t.includes(e))return Promise.reject();Promise.resolve()})}},{key:"upgrade",value:function(t,r){var n=this;return this.open().then(function(){n.version!==r&&(n.version=r);var o=Object.keys(n.storage).filter(function(e){return 0===e.indexOf(n.name+"::"+t+"_")}).map(function(e){return e.replace(n.name+"::"+t+"_","")}),i=[],u=function(r){var o=n.storage.getItem(n.name+"::"+t+"_"+r);try{var u=JSON.parse(o);u&&"object"===(void 0===u?"undefined":e(u))&&(o=u)}catch(e){}return i.push(n.set(r,o).then(function(){return n.storage.removeItem(n.name+"::"+t+"_"+r)})),{v:Promise.all(i)}},s=!0,a=!1,c=void 0;try{for(var l,v=o[Symbol.iterator]();!(s=(l=v.next()).done);s=!0){var f=u(l.value);if("object"===(void 0===f?"undefined":e(f)))return f.v}}catch(e){a=!0,c=e}finally{try{!s&&v.return&&v.return()}finally{if(a)throw c}}return Promise.reject()})}},{key:"rename",value:function(e){var t=this;return this.name!==e?this.keys().then(function(r){var n=t.id;t.name=e,t.id=t.name+"::"+t.version+"_";var o=[],i=function(e){o.push(t.set(e,t.storage.getItem(""+n+e)).then(function(){t.storage.removeItem(""+n+e)}))},u=!0,s=!1,a=void 0;try{for(var c,l=r[Symbol.iterator]();!(u=(c=l.next()).done);u=!0){i(c.value)}}catch(e){s=!0,a=e}finally{try{!u&&l.return&&l.return()}finally{if(s)throw a}}return Promise.all(o)}):Promise.reject()}},{key:"key",value:function(e){var t=this,r=arguments.length>1&&void 0!==arguments[1]&&arguments[1];return this.open().then(function(){return!0===r?Promise.resolve(t.storage.key(e)):Promise.resolve(t.storage.key(e).replace(t.id,""))})}},{key:"keys",value:function(){var e=this,t=arguments.length>0&&void 0!==arguments[0]&&arguments[0];return this.open().then(function(){return Promise.resolve(Object.keys(e.storage).filter(function(t){return 0===t.indexOf(e.id)}).map(function(r){return!0===t?r:r.replace(e.id,"")}))})}},{key:"remove",value:function(e){var t=this;return this.get(e).then(function(r){return t.storage.removeItem(t.id+e),Promise.resolve(r)})}},{key:"clear",value:function(){var e=this;return this.keys().then(function(t){var r=!0,n=!1,o=void 0;try{for(var i,u=t[Symbol.iterator]();!(r=(i=u.next()).done);r=!0){var s=i.value;e.remove(s)}}catch(e){n=!0,o=e}finally{try{!r&&u.return&&u.return()}finally{if(n)throw o}}return Promise.resolve()})}}]),n}();
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){function e(e,r){for(var n=0;n<r.length;n++){var t=r[n];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(e,t.key,t)}}return function(r,n,t){return n&&e(r.prototype,n),t&&e(r,t),r}}();function r(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}var n=exports.Util=function(){function n(){r(this,n)}return e(n,null,[{key:"callAsync",value:function(e,r){try{for(var n=arguments.length,t=Array(n>2?n-2:0),o=2;o<n;o++)t[o-2]=arguments[o];var a=e.apply(r,t);return a instanceof Promise?a:Promise.resolve(a)}catch(e){return Promise.reject(e)}}},{key:"uuid",value:function(){if(window.crypto)return([1e7]+-1e3+-4e3+-8e3+-1e11).replace(/[018]/g,function(e){return(e^crypto.getRandomValues(new Uint8Array(1))[0]&15>>e/4).toString(16)});var e=function(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)};return e()+e()+"-"+e()+"-"+e()+"-"+e()+"-"+e()+e()+e()}}]),n}();
