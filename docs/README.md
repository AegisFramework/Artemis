...
* [Artemis](#Artemis)
    ...
    * [.replaceWith(element)](#Artemis+replaceWith)
    * [.reset()](#Artemis+reset)
    * [.property(property, [value])](#Artemis+property) ⇒ <code>type</code>
    * [.hide()](#Artemis+hide)
    * [.show([display])](#Artemis+show)
    * [.addClass(newClass)](#Artemis+addClass)
    * [.removeClass([oldClass])](#Artemis+removeClass)
...
| Param | Type | Description |
| --- | --- | --- |
| element | <code>type</code> | Element to replace the current one with |
...
### artemis.property(property, [value]) ⇒ <code>type</code>
Get or set a property for the first element in the collection

**Kind**: instance method of [<code>Artemis</code>](#Artemis)  
**Returns**: <code>type</code> - - If no value is provided, this funcion will return the
...
* [DOM](#DOM)
    ...
    * [.on(event, callback, target)](#DOM+on)
